    ...
    <section className="relative overflow-hidden bg-[#030303] pt-12 pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-b from-[#062114] to-[#010a05] border border-emerald-500/20 py-20 px-6 sm:px-12 text-center shadow-2xl">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -z-10 h-72 w-[110%] rounded-b-full bg-emerald-500/[0.04] blur-2xl" />
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            {/* Header label */}
            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-900/20 px-4 py-1.5 text-xs text-emerald-300 font-mono">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-xl mx-auto font-sans text-xs sm:text-sm text-emerald-100/70 leading-relaxed pt-2">
            ...
            <div className="pt-4 flex flex-col items-center justify-center gap-3">
              ...
              <span className="font-mono text-[10px] text-emerald-500/80 uppercase tracking-widest block pt-1">
                Instant confirmation • Available with Google Meet invites
              </span>
            </div>

            {/* Telemetry checks under booking button */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-10 border-t border-emerald-500/10 text-left text-xs text-emerald-100/60 font-sans max-w-2xl mx-auto">
