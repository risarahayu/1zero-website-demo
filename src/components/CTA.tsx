...
export default function CTA({ onOpenBooking }: CTAProps) {
  return (
    <section className="relative overflow-hidden bg-[#030303] py-16 ">

      {/* Curved Emerald Backdrop container */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-b from-[#062114] to-[#010a05] border border-emerald-500/20 py-16 px-6 sm:px-12 text-center shadow-2xl">
          ...
          <div className="max-w-3xl mx-auto space-y-10">
            {/* Header label */}
            <div className="inline-flex items-center gap-2 rounded-full border border-brunswick-green-500/20 bg-emerald-900/20 px-4 py-1.5 text-lg text-emerald-300 font-sans">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-10 border-t border-emerald-500/10 text-left text-lg text-emerald-100/60 font-sans max-w-2xl mx-auto">
