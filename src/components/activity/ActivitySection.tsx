...
export function ActivitySection(total?: number) {
    ...
    return (
        <section className="py-16 text-slate-50 relative space-y-10 max-w-7xl mx-auto" id="activity">
            ...
            <div className="flex justify-center gap-3 mt-12">
                <button aria-label="Button Previous Page"
                ...
                <button aria-label="Button Next Page"
                    onClick={() => setCurrentPage((prev) => prev + 1)}
