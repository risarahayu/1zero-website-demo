...
export default function WhyUs({ onOpenBooking }: WhyUsProps) {
  ...
  return (
    <section id="why-us" className="relative py-16 bg-neutral-950/40">
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between rounded-3xl border border-neutral-900 bg-black/60 p-5 shadow-2xl relative space-y-4">
              {/* Header bar */}
              <div className="flex items-center justify-between pb-3 border-b border-neutral-900 text-lg font-sans text-sea-salt">
                    ...
                    >
                      ...
                      <div className="space-y-1.5 mt-auto z-10 pt-2 bg-gradient-to-t from-black via-black/80 to-transparent">
                        <div className="flex items-center justify-between">
                          <span className="block font-sans text-lg font-bold text-white  tracking-wide truncate">
                            {member.name}
                          </span>
            ...
            <div className="lg:col-span-7 flex flex-col justify-center space-y-6">
              ...
              <div className="pt-4 border-t border-neutral-900 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                className="p-3 px-6 rounded-xl bg-green-primary hover:bg-emerald-600 text-black font-sans font-medium text-lg transition-colors cursor-pointer block text-center shadow-lg"
              >
                Hire Our Unit &rarr;
              </button> */}
              </div>
