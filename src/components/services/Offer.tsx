                    ...
                    return (
                        ...
                        >
                            ...
                            <button aria-label="Button Dropdown Header"
                                ...
                                className="w-full flex items-center justify-between p-6 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-sea-salt group"
                            >
                                                ...
                                                <div className="space-y-8">
                                                    ...
                                                    <div className="p-6 rounded-xl border border-sea-salt/20 bg-sea-salt/5 shadow-2xl">
                                                        ...
                                                        <div className="flex flex-col gap-4">
                                                            ...
                                                            {item.fileEng && (
                                                                <div className="mt-4">
                                                                    <a href={item.fileEng} download className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brunswick-green-900 text-sea-salt hover:bg-brunswick-green-700 transition-colors">
