    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div className="absolute -top-32 -left-32 -z-10 h-64 w-64 rounded-full bg-emerald-500/10 blur-3xl" />
          <div className="absolute -bottom-32 -right-32 -z-10 h-64 w-64 rounded-full bg-emerald-500/5 blur-3xl" />
          ...
          <div className="flex items-center justify-between pb-4 border-b border-neutral-800/80">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="font-mono text-[10px] uppercase tracking-wider text-neutral-400">30-Min Consultation</p>
              </div>
            </div>
            <button 
              id="close-modal-btn"
          ...
          {step < 3 && (
            <div className="flex items-center justify-center gap-2 py-4">
              <div className={`h-1.5 w-12 rounded-full transition-all duration-300 ${step >= 1 ? "bg-emerald-500" : "bg-neutral-800"}`} />
              <div className={`h-1.5 w-12 rounded-full transition-all duration-300 ${step >= 2 ? "bg-emerald-500" : "bg-neutral-800"}`} />
              <div className={`h-1.5 w-12 rounded-full transition-all duration-300 ${step >= 3 ? "bg-emerald-500" : "bg-neutral-800"}`} />
            </div>
          )}

          {/* Error Banner */}
          {errorStatus && (
            <div className="flex items-center gap-2 rounded-lg bg-rose-500/10 p-3 text-xs text-rose-400 border border-rose-500/20 mb-4 animate-shake">
          ...
          {step === 1 && (
            <div className="space-y-6 py-2">
              <div>
                <label className="block font-sans text-xs font-semibold text-neutral-400 mb-3">1. Select a Date</label>
                  ...
                  {getUpcomingDays().map((day) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="font-sans text-[10px] text-neutral-500 mt-0.5">{day.month}</span>
                      </button>
                    );
                  })}
                </div>
              ...
              <div>
                <label className="block font-sans text-xs font-semibold text-neutral-400 mb-3">2. Available Slots</label>
                  ...
                  {timeSlots.map((time) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center justify-center gap-1.5 p-2.5 rounded-xl border font-mono text-xs transition-all ${
                          isSelected 
                            ? "border-emerald-500 bg-emerald-500/10 text-white shadow-[0_0_15px_rgba(16,185,129,0.15)] font-semibold" 
                            : "border-neutral-800 bg-[#111] hover:border-neutral-700 text-neutral-300 hover:text-white"
                        }`}
                      >
              ...
              <div className="flex items-center gap-2 rounded-xl bg-neutral-900/60 p-3 border border-neutral-800/80">
                ...
                <div className="flex-1">
                  <span className="block text-[10px] text-neutral-500 font-mono">TIMEZONE</span>
                  <select 
                    id="timezone-select"
                    value={timezone} 
                    onChange={(e) => setTimezone(e.target.value)}
                    className="w-full bg-transparent text-xs font-sans text-neutral-200 focus:outline-none cursor-pointer"
                  >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 w-full p-3.5 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-black font-display font-bold text-sm tracking-wide transition-all shadow-[0_4px_20px_rgba(16,185,129,0.2)] cursor-pointer"
              >
          ...
          {step === 2 && (
            <form onSubmit={handleBookSubmit} className="space-y-4 py-2">
              <div className="text-neutral-400 bg-neutral-900/60 p-3 rounded-xl border border-neutral border-neutral-800/80 text-xs mb-2">
              ...
              <div className="space-y-1">
                <label className="block text-xs font-semibold text-neutral-400">Full Name *</label>
              ...
              <div className="space-y-1">
                <label className="block text-xs font-semibold text-neutral-400">Business Email Address *</label>
                <div className="relative">
              ...
              <div className="space-y-1">
                <label className="block text-xs font-semibold text-neutral-400">Company Name (Optional)</label>
                <div className="relative">
              ...
              <div className="space-y-1">
                <label className="block text-xs font-semibold text-neutral-400">What are we building together? (Brief notes)</label>
                <textarea
                  ...
                  className="w-full p-3.5 rounded-xl bg-neutral-900/60 border border-neutral-800 text-xs focus:outline-none focus:border-emerald-500/80 focus:ring-1 focus:ring-emerald-500/40 text-white font-sans transition-all resize-none"
                />
              </div>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  id="modal-submit-btn"
                  type="submit"
                  className="flex-1 p-3 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-black font-display font-medium text-sm tracking-wide transition-all shadow-[0_4px_20px_rgba(16,185,129,0.2)] cursor-pointer"
                >
            ...
            <div className="text-center py-6 space-y-6">
              ...
              <div className="max-w-md mx-auto rounded-xl bg-neutral-900/60 p-4 border border-emerald-500/10 space-y-3 divide-y divide-neutral-800 text-left">
                <div className="pb-3 text-xs">
                  <p className="font-mono text-[10px] text-emerald-400 tracking-wider">EVENT SUMMARY</p>
                ...
                <div className="py-2.5 pt-3 flex items-center gap-3 text-xs text-neutral-300">
                  <Calendar className="h-4 w-4 text-emerald-400 shrink-0" />
                  <span>{selectedDate}</span>
                </div>
                <div className="py-2.5 flex items-center gap-3 text-xs text-neutral-300">
                  <Clock className="h-4 w-4 text-emerald-400 shrink-0" />
                  <span>{selectedTime} ({timezone})</span>
                </div>
                <div className="pt-3 flex items-center gap-3 text-xs text-neutral-300">
